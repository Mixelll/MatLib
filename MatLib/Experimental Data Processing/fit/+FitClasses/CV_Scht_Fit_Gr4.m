classdef CV_Scht_Fit_Gr4 < matlab.mixin.SetGet
	properties
        T = 296;
        Range = [-inf inf]
        Area = (150e-4)^2 * pi
	...
	methods 
        function Fit(o, x,y, Target, varargin)
            DefNameValueTemp = fn_struct2cell(C_schot_fit2_B4('parser','','','','','','','',''));
            ...
            [FitLeg, fun, span] = C_schot_fit2_B4(x,y,o.Area,o.RelativePermitivitty,o.Doping,o.Vb,o.IdealityFactor,o.Graphene_Doping,o.Graphene_Vdrop_Coeff,o.FitProperties,Limits{:});
            hold(Target, 'on')
            if ~isempty(varargin)
                legend(varargin{:});
        ...
        function OK = Menu(o)
            [~, OK, Pairs] = StructrureFieldsMenu(o,@parse_num_cell_sym2char,@parse_str2num_cell_sym,['Input Fit Parameters for model ' C_schot_fit2_B4('model','','','','','','','','')]);
            if OK
                set(o, Pairs{:})
            end
        end
